          ...
          <div className="logoSection">
            <div className="logoIcon">
              <svg width="32" height="32" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M15 12h10M15 20h10M15 28h6" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
              </svg>
            </div>
          ...
          {user && (
            <>
              <div className="userAvatar">
                ...
                <div className="userAvatarInitials" style={{ display: hasAvatar() ? "none" : "flex" }}>
                  {getUserInitials()}
                </div>
              </div>
            ...
            {isLoadingNotes ? (
              ...
              <div className="notesGrid">
                {notes.map((note, index) => (
                  ...
                  >
                    <button className="noteDeleteBtn" onClick={(e) => handleDeleteNote(note.id, e)} title="Delete note">
                      ×
                    </button>
                    <div className="noteDate">{note.createdAt ? formatDate(note.createdAt) : "No date"}</div>
